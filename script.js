...
document.addEventListener("DOMContentLoaded", e3 => {
  const store3 = {
    ...
    "Yuyuantan Park1": "Our department of Workshops Inc. wishes for everyone at Malhar to experience learning alongside fun with a wide range of hands on workshops ranging from art, cooking, forensics, styling, dance, music and much more. We believe in aiding the broadening of every participant's horizons and enabling each one to grow in multitudes of ways. WINC is a humble abode, and we will make sure you have a wholesome time!"
  };
